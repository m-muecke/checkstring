...
test_that("is_ipv6 works", {
  expect_true(is_ipv6("2001:0db8:85a3:0000:0000:8a2e:0370:7334"))
  expect_true(is_ipv6("fe80:0000:0000:0000:0000:0000:0000:0001"))
  expect_true(is_ipv6("FE80::1"))
  expect_true(is_ipv6("::1"))
  expect_true(is_ipv6("::"))
  expect_true(is_ipv6("2001:db8::1"))
  expect_true(is_ipv6("2001:db8::8a2e:370:7334"))
  expect_true(is_ipv6("fe80::1"))
  expect_true(is_ipv6("1:2:3:4:5:6:7::"))
  expect_true(is_ipv6("::1:2:3:4:5:6:7"))
  expect_true(is_ipv6("::ffff:192.168.1.1"))
  expect_true(is_ipv6("2001:db8::192.168.1.1"))
  expect_true(is_ipv6("::1.2.3.4"))
  expect_true(is_ipv6("1:2:3:4:5:6:1.2.3.4"))

  expect_false(is_ipv6("2001:db8::8a2e::7334"))
  expect_false(is_ipv6("2001:0db8:85a3:0000:0000:8a2e:0370"))
  expect_false(is_ipv6("2001:0db8:85a3:0000:0000:8a2e:0370:7334:1234"))
  expect_false(is_ipv6("2001:0db8:85a3:0000:0000:8a2e:0370:gggg"))
  expect_false(is_ipv6("::12345"))
  expect_false(is_ipv6("::ffff:999.168.1.1"))
  expect_false(is_ipv6("1:2:3:4:5:6:1.2.3"))
  expect_false(is_ipv6("1.2.3.4::"))
  expect_false(is_ipv6("192.168.1.1"))
  expect_false(is_ipv6("1:2:3:4:5:6:7:8:"))
  expect_false(is_ipv6(":1:2:3:4:5:6:7:8"))
  expect_false(is_ipv6("1::2:"))
  expect_false(is_ipv6("::1:"))
  expect_false(is_ipv6(":1::2"))
  expect_false(is_ipv6("a:b:c:d:e:f:0:1::"))
  expect_false(is_ipv6(":::"))
  expect_false(is_ipv6("1:::2"))
  expect_false(is_ipv6(":"))
  expect_false(is_ipv6(""))
  expect_false(is_ipv6(1L))
})
